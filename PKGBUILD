...
if [ -n "$_use_llvm_lto" ]; then
  pkgbase=linux-cachyos-nspa-lto
else
  pkgbase=linux-cachyos-nspa
fi
_major=5.15
_minor=11
...
source=(#"https://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
  ...
  "0001-amdpstate.patch"
  "amd-sched.patch"
  "0001-amd64-patches.patch"
  "0001-bbr2.patch"
  ...
  "0001-intel-patches.patch"
  "0001-ntfs3.patch"
  "0001-ck-hrtimer.patch"
  "0001-fixes-miscellaneous.patch"
  "0001-futex-wait.v-fsync-winesync.patch"
  "0001-hwmon-patches.patch"
  "0001-ksmbd-patches.patch"
  "0001-pf-patches.patch"
  "0001-page-table-check.patch"
  "0001-lqx-patches.patch"
  "0001-lrng-patches.patch"
  "0001-v4l2loopback.patch"
  "0001-security-patches.patch"
  "0001-spectre-patches.patch"
  "0001-sbitmap-patches.patch"
  "0001-xanmod-patches.patch"
  "0001-net-patches.patch"
  "0001-zstd.patch"
  "auto-cpu-optimization.sh"
  "0060-x86-Enable-fast-strings-on-Intel-if-BIOS-hasn-t-alre.patch"
  "0020-mm-Lower-the-non-hugetlbpage-pageblock-size-to-reduc.patch"
  "0021-mm-Don-t-hog-the-CPU-and-zone-lock-in-rmqueue_bulk.patch"
  "0030-sched-fair-Compile-out-NUMA-code-entirely-when-NUMA-.patch"
  "0001-mm-Support-soft-dirty-flag-reset-for-VA-range.patch"
  "0002-mm-Support-soft-dirty-flag-read-with-reset.patch"
)

if [ -n "$_use_pgo" ]; then
  source+=("0001-PGO.patch")
fi
...
md5sums=('7fcbea316f8439d092040996295c8f9d'
         ...
         'b566a97c8484ac14c48e957a2df4ee70'
         'a1bdff580b5d437aac2a82787dae725e'
         '4e045a43169549264cf51eca4fb01c15'
         'baf1fac3e4b4abb4e9b9fb0fca97a699'
         '6eba5c2051cc4ace6e5748bc7e031e79'
         'fbcc5c44ea0e0da0d7f73df2377cedbb')
